...
class Classifier {
  ...
  Future<void> _loadModel() async {
    ...
    } catch (e) { print('❌ خطأ في تحميل الموديل: $e'); }
  }
  bool _isValidPalmColor(img.Image image) {
    ...
    if (avgG > 200 && avgR < 120) return false; // أخضر فاقع جداً (أشجار زينة صناعية)
    if (avgB > avgG && avgB > avgR) return false; // سماء أو ملابس زرقاء
    if (avgR > 240 && avgG > 240 && avgB > 240) return false; // بياض فاقع جداً (إضاءة شمس قوية أو جدار أبيض)
